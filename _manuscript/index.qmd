...
- Write about the parser, and the Lark parser
- Include lark parsing code, but do not echo it; just do some spot tests
  to show that the parser works
- Afterwards, we can go onto encoding
